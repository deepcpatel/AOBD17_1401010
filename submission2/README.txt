...
5)PPCA.m
This is the user defined function for PPCA using closed form.

6)PPCA_Test.m
This is a simple script testing the PPCA.m function for regenerating an image matrix using closed form PPCA
